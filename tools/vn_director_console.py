...
def status(args: argparse.Namespace) -> int:
    ...
    print(f"[{'✓' if contract else '!'}] Ren'Py project contract")
    print(f"[{'✓' if vault and vault.exists() else '!'}] Obsidian production vault")
    print(f"[{'✓' if manifest.exists() else '!'}] Asset manifest")
    print(f"[{'✓' if queue.exists() else '!'}] Owner review queue")
...
def new_scene(args: argparse.Namespace) -> int:
    ...
    print('')
    print('Created:')
    print(f'[✓] Obsidian scene note: {note}')
    if draft:
        print(f"[✓] Ren'Py placeholder draft: {draft}")
    else:
        print("[ ] Ren'Py placeholder draft: skipped")
    print(f'[✓] Asset request sync scenes: {scene_count}')
    print(f'[✓] Owner review queue: {project_root / "docs/production/owner_review_queue.md"}')
    print(f'[✓] Director card: {card}')
    print('')
